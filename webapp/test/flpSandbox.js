		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Liquidaciones",
									"targetURL": "#liqhrenapclzhrliquidaciones-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"liqhrenapclzhrliquidaciones-display": {
								"semanticObject": "liqhrenapclzhrliquidaciones",
								"action": "display",
								"description": "App de Liquidaciones",
								"title": "Liquidaciones",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=enap.com.zapp_hr_get_liq",
									"url": sap.ui.require.toUrl("enap/com/zapp_hr_get_liq")
								}
							}
						}
					}
